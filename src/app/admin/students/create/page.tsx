    ...
    useEffect(() => {
        async function loadOptions() {
            try {
                ...
                if (parentsRes.ok) setParents(parentsJson.data ?? []);
            } catch (e) {
                console.error(e);
            }
        }
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const body = {
                ...
                medical_info: form.medical_info || undefined,
        ...
        <div className="max-w-5xl mx-auto pb-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div className="space-y-1">
                    ...
                    <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase italic">Enroll New Student</h1>
                    <p className="text-slate-500 font-medium font-sans">Initialize academic and secure access records.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-white/50 backdrop-blur-xl border border-slate-100 rounded-[3rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            <label className={labelClasses}>Unique Student ID *</label>
                            <input
                                required
                ...
                <div className="flex items-center justify-between pt-6 border-t border-slate-100">
                    <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Ensuring Directory integrity & protocol compliance.</p>
                    <div className="flex gap-4">
                        ...
                        >
                            {loading ? 'Processing...' : 'Authorize & Create Student'}
                        </button>
                    </div>
                </div>
            </form>
