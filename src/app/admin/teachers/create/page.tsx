            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div className="space-y-1">
                    <div className="flex items-center gap-3 mb-2">
                        <Link href="/admin/teachers" className="text-xs font-black text-indigo-600 uppercase tracking-widest hover:underline italic">← Return to Faculty</Link>
                    </div>
                    <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase italic">Recruit Faculty</h1>
                    <p className="text-slate-500 font-medium font-sans">Initialize professional and secure access records.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-white/50 backdrop-blur-xl border border-slate-100 rounded-[3rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 mb-10">
                        ...
                        <h3 className="text-xl font-black text-slate-800 uppercase italic tracking-tighter">Professional Identity</h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setForm({ ...form, teacher_id: e.target.value.toUpperCase() })}
                            />
                        </div>
                        <div>
                            ...
                            <input
                                type="email"
                                placeholder="e.g. smith.j@school.com"
                                className={inputClasses}
                                value={form.email}
                ...
                <div className="bg-white/50 backdrop-blur-xl border border-slate-100 rounded-[3rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 mb-10">
                        ...
                        <h3 className="text-xl font-black text-slate-800 uppercase italic tracking-tighter">Credentials</h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <input
                                placeholder="e.g. Ph.D. in Theoretical Physics"
                                className={inputClasses}
                ...
                <div className="flex items-center justify-between pt-6 border-t border-slate-100">
                    <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Ensuring Faculty directory integrity & compliance.</p>
                    <div className="flex gap-4">
                        ...
                        >
                            {loading ? 'Processing...' : 'Authorize & Recruit Faculty'}
                        </button>
                    </div>
                </div>
            </form>
